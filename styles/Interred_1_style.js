var size = 0;
var placement = 'point';
function categories_Interred_1(feature, value, size, resolution, labelText,
...
var style_Interred_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 0;
    var placement = 'point';
    if (feature.get("NameI") !== null  && resolution < 0.0000009) {
        labelText = String(feature.get("NameI"));
    }
    
    var style = categories_Interred_1(feature, value, size, resolution, labelText,
