...
//       expandedAttribution,new ol.control.ScaleLine({})
       expandedAttribution,new ol.control.ScaleLine({bar:true})

    ]),

// add new code here for Scaleline control
//	controls: ol.control.defaults({attribution:false}).extend([
...
//    ]),
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-73.990003, 41.942262, -73.984436, 41.945581], maxZoom: 5, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            extent: [-73.988637, 41.942569, -73.985672, 41.944423],
            units: 'degrees'})
    })
});
...
map.getView().fit([-73.990003, 41.942262, -73.984436, 41.945581], map.getSize());
