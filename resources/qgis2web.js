...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-73.990058, 41.941629, -73.983933, 41.944953], maxZoom: 22, minZoom: 12, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            //extent: [-73.988640, 41.942551, -73.985664, 41.944424],
            units: 'degrees'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-73.990058, 41.941629, -73.983933, 41.944953], map.getSize());
...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-73.989726, 41.941484, -73.984597, 41.944884], maxZoom: 22, minZoom: 12, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            //extent: [-73.988640, 41.942551, -73.985664, 41.944424],
            units: 'degrees'})
    })
...
//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-73.989726, 41.941484, -73.984597, 41.944884], map.getSize());
